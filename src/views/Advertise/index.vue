...
import AddAdvertiseDialog from "./components/AddAdvertiseDialog.vue";
import AdvertisePositionDialog from "./components/AdvertisePositionDialog.vue";
...
const advertiseRef = ref<InstanceType<typeof AdvertisePositionDialog>>();
...
<template>
  <div class="advertise">
    ...
    <AddAdvertiseDialog ref="formDialogRef" />
    <AdvertisePositionDialog ref="advertiseRef" />
  </div>
</template>
